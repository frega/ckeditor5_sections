...
`,o.a.customElements.define("ck-button",he);var pe=n(56),ue=n.n(pe);class me extends Ut{static get properties(){return{label:{type:String},resolved:{type:Boolean},isResolving:{type:Boolean}}}constructor(){super(),this.label=me.label,this.resolved=!1,this.isResolving=!1}connectedCallback(){super.connectedCallback(),Array.from(this.children).forEach(t=>t.addEventListener("optionSelected",this.selectOptionHandler.bind(this))),document.addEventListener("click",t=>{!this.contains(t.target)&&this.isResolving&&(this.isResolving=!1)})}render(){return B`
    ...
    `}clickResolvingHandler(){this.isResolving=!0}selectOptionHandler(t){this.resolved=!0,this.isResolving=!1,this.modifyDocument(e=>e.swap(t.detail,this))}}me.label="Conflict needs resolving";var be=n(57),ge=n.n(be);class ve extends mt{static get properties(){return{from:{type:String},content:{type:String}}}render(){return B`
      <style>
        ${ge.a}
      </style>
