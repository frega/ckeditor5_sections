...
`,o.a.customElements.define("ck-button",he);var pe=n(56),ue=n.n(pe);class me extends Ut{static get properties(){return{label:{type:String},resolved:{type:Boolean},isResolving:{type:Boolean}}}constructor(){super(),this.label=me.label,this.resolved=!1,this.isResolving=!1}connectedCallback(){super.connectedCallback(),Array.from(this.children).forEach(t=>t.addEventListener("optionSelected",this.selectOptionHandler.bind(this))),document.addEventListener("click",t=>{!this.contains(t.target)&&this.isResolving&&(this.isResolving=!1)})}render(){return B`
    ...
    `}clickResolvingHandler(){this.isResolving=!0}selectOptionHandler(t){this.resolved=!0,this.isResolving=!1,this.modifyDocument(e=>e.swap(t.detail,this))}}me.label="Conflict needs resolving";var be=n(57),ge=n.n(be);class ve extends mt{static get properties(){return{from:{type:String},content:{type:String}}}connectedCallback(){super.connectedCallback(),this.content=this.innerText}render(){return B`
      <style>
        ${ge.a}
      </style>
    ...
    `}firstUpdated(){"left"===this.position&&(this.style.width="50%",setTimeout(()=>{this.shadowRoot.querySelector(".media-conflict-option").style.minWidth=`${2*this.offsetWidth}px`},100))}optionSelected(){this.dispatchEvent(new CustomEvent("optionSelected",{detail:this.children.item(0)}))}}we.labels={left:"Left version",right:"Right version",source:"Source version",empty:"Clear"},o.a.customElements.define("ck-conflict-media",ye),o.a.customElements.define("ck-conflict-media-option",we);var Se=n(60),Ee=n.n(Se);const Ce=D`
...
`;o.a.customElements.define("ck-media",class extends Ut{static get properties(){return{loaderIsVisible:Boolean,mediaType:{attribute:"data-media-type",type:String},mediaUuid:{attribute:"data-media-uuid",type:String},mediaDisplay:{attribute:"data-media-display",type:String},enableUpload:{attribute:"ck-upload",type:Boolean},enableEdit:{attribute:"ck-edit",type:Boolean},buttonPosition:{attribute:"ck-button-position",type:String},preview:String,error:Boolean}}validate(){const t=this.error;this.error=!this.mediaUuid,!t&&this.error?this.emitElementValidationErrorEvent("Media is required","media_required"):t&&!this.error&&this.emitElementValidationErrorResolvedEvent()}connectedCallback(){super.connectedCallback(),this.requestInformation("show-errors",{},t=>{t&&this.validate()})}renderPreview(){this.loaderIsVisible=!0,this.requestInformation("media-preview",{type:this.mediaType,uuid:this.mediaUuid,display:this.mediaDisplay},t=>{this.preview=t,this.loaderIsVisible=!1})}updated(t){this.previewPane=this.shadowRoot.querySelector(".ck-media__preview"),t.has("mediaUuid")&&this.mediaUuid&&(this.validate(),this.renderPreview()),t.has("preview")&&this.preview&&(this.previewPane.innerHTML=this.preview)}render(){return B`
    ...
    `}}Oe.initializeWithErrors=!1,o.a.customElements.define("ck-textfield",Oe);var Le=n(62),Me=n.n(Le);o.a.customElements.define("ck-collapse",class extends Yt{static get properties(){return{collapseIsOpen:{type:Boolean}}}connectedCallback(){super.connectedCallback(),null==this.collapseIsOpen&&(this.collapseIsOpen=!1)}toggleCollapse(){this.collapseIsOpen=!this.collapseIsOpen}render(){return B`
      <style>
        ${Me.a}
      </style>
